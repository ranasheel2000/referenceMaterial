# JLPT N3 - Day 4: Grammar, Vocabulary & Kanji

## Overview
Day 4 covers eight essential grammar structures that express tendencies, states, and appearances, along with key vocabulary and kanji for describing conditions and characteristics.
...
3. げ (appears to be / looks like)
4. っぽい (has a feeling of / seems like)
5. だらけ (full of / covered in)
6. っぱなし (left as is / continuing)
7. っけ (confirmation of forgotten info)
8. じゃない (I think it's / isn't it)

### Vocabulary Items

| Vocabulary | Meaning |
|------------|---------|
| AむしろB | A rather B / B is preferable to A |
| A今でもB | A is still B |
| 突然 (とつぜん) | Suddenly |
| くれぐれも | Please / I earnestly request |
| いつの間にか | Before one becomes aware of |
| 一瞬 (いっしゅん) | Moment / for a moment |
| A今ではB | A is now B |
| (~に)気がつく | Be attentive / become aware |
...
### Meaning
Often becomes ~; frequently becomes ~
- Often in the state of ~
- The rate/frequency of ~ is high

### Key Points
- Often used for negative or undesirable trends
- Indicates a pattern that occurs repeatedly
...
### Meaning
Feels a bit/somewhat ~
- Sense or feeling of ~
- A slight condition or state

### Key Points
- Usually used for negative or undesirable conditions
- Attaches to words describing states or conditions
- **Difference from がち:** "Gachi" is used when a pattern is recognized through repetition; "Gimi" refers only to the current state
...
- Describes a person's state of being (somewhat old-fashioned)
- An observable appearance or demeanor

### Key Points
- Not often used to describe the condition of superiors (敬語)
- More formal/written expression than ~そう
- Can be replaced with ~そう, but ~げ is more literary
...
### Meaning
That's how it feels/appears
- Often does ~; tends to ~
- Gets ~ easily
- Has a characteristic or nature of ~

### Key Points
- Expresses the nature of something, not the frequency of actions
- Used with verbs like: 怒る (get angry), 飽きる (get bored), 忘れる (forget)
- Often used for negative characteristics
...
### Meaning
Full of ~; covered in ~
- Filled with (usually negative things like mud, wrinkles, mistakes)
- Abundant with undesirable elements

### Key Points
- Expresses that something is completely filled with negative or undesirable things
- Often used in contexts of damage, dirt, or errors
...
### Meaning
Left in a state of ~; still ~; continuing to do ~
- Left undone; remaining in an incomplete state

### Key Points
- **Mode 1 (Negligence):** Leaves something in a state without doing what should be done afterward
- **Mode 2 (Continuity):** Continues in a state for an extended period
- Usually carries a negative connotation
- Implies carelessness or prolonged undesirable conditions
...
### Meaning
Used to confirm something unclear or forgotten
- A reminder of information previously heard but forgotten

### Key Points
- Spoken language primarily
- Usually in the form: past tense + っけ
- Cannot be used with adjectives in past tense form
...
- Criticism or surprise toward someone

### Key Points
- **Speculation:** Raise intonation at the end (I think it's ~)
- **Confirmation:** Raise intonation at the end (Isn't it ~?)
- **Criticism/Surprise:** Lower intonation at the end (That's great, isn't it!)
- NOT a negation
- ~じゃん is used similarly but mainly in close relationships
...
### (~に)気がつく
**Meaning:** Be attentive / become aware

Meanings:
1. Becoming aware of something previously unknown
...
1. **Negative Patterns:** がち, 気味, っぽい, だらけ, and っぱなし often describe negative or undesirable conditions
2. **Repetition vs. Current State:** Distinguish between がち (repetition) and 気味 (current state)
