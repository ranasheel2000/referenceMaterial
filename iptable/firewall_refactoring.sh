...
#iptables -A INPUT -m mac --mac-source B8:81:98:22:C7:6B -j ACCEPT
#iptables -A INPUT -m mac --mac-source B8:81:98:22:C6:7C -j ACCEPT
#iptables -A INPUT -m mac --mac-source B8:81:98:22:23:AB -j ACCEPT
#iptables -A INPUT -m mac --mac-source B8:81:98:22:67:AA -j ACCEPT
